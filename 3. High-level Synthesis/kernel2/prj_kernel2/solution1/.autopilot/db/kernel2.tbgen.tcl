set C_TypeInfoList {{ 
"kernel2" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"array": [[], {"array": [ {"scalar": "int"}, [1024]]}] }],[],""]
}}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.kernel2_mul_32s_3bkb_U1", "Parent" : "0"}]}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "5110", "Max" : "5110"}
	, {"Name" : "Interval", "Min" : "5111", "Max" : "5111"}
]}
