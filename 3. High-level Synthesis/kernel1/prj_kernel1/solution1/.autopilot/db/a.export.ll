...
@kernel1_str = internal unnamed_addr constant [8 x i8] c"kernel1\00"
@p_str1 = private unnamed_addr constant [1 x i8] zeroinitializer, align 1
@p_str = private unnamed_addr constant [12 x i8] c"hls_label_0\00", align 1

declare void @llvm.dbg.value(metadata, i64, metadata) nounwind readnone

define void @kernel1([1024 x i32]* %array_r) nounwind uwtable {
...
; <label>:2                                       ; preds = %1
  ...
  %tmp = zext i11 %i to i64
  %array_addr = getelementptr [1024 x i32]* %array_r, i64 0, i64 %tmp
  %array_load = load i32* %array_addr, align 4
  %tmp_3 = shl i32 %array_load, 2
  %tmp_1 = add i32 %array_load, %tmp_3
  store i32 %tmp_1, i32* %array_addr, align 4
